...
This repository provides samples demonstrating how to use Oracle Agent AI Studio to build app, workflows, etc.
...
| Workflow | A step-by-step deteministic flow that can call AI, services, code, or approvals. | Fetch data, analyze it, make recommendations, and return results. |
